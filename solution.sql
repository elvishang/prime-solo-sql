...
UPDATE "syntax_practice" SET "account_balance" = 10.00 WHERE ("transactions_completed" = 0 AND "transactions_attempted" = 0);
...
VALUES ('elvishang', 'minneapolis', '110', '110', '1000000');
